    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        if(session!=null){
            ...
            if (!isMultipartContent) {
                ...
                request.getRequestDispatcher("csvupload.jsp").include(request, response);
            }else{
			...
			out.println("Please select a file<br/>");
                        ...
                        if(fileItem.getName()==null || fileItem.getName().isEmpty()){
                            ...
                            if(ext.equals("csv")){
                                ...
                                request.getRequestDispatcher("csvfields.jsp").forward(request, response);
                            }else{
                                out.println("Please upload a csv file.<br/>");
                                request.getRequestDispatcher("csvupload.jsp").include(request, response);
                            }
