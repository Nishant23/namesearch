...
<html>
    ...
    <body>
        ...
        %>
            <form class="form-horizontal" style="margin-top:100px;" name="form1" id="form1" action="txtread" method="post" enctype="multipart/form-data">
            <%
            for(int i=0;i<l;i++){
            %>
        ...
        %>
        No content in file.
        <a href="txtupload.jsp">Go back</a>
        <%    
        }
        br.close();
        file.close();
